	...
	function school_education_footer_copyright() {
		...
		<div class="colophon-inner">
		    ...
		    <?php if ( ! empty( $school_education_powered_by_text ) ) : ?>
			    <div class="colophon-column">
			    	<div class="site-info">
			    		<a href="<?php echo esc_url('https://www.mizanthemes.com/elementor/free-education-wordpress-theme/','school-education'); ?>"><?php echo $school_education_powered_by_text; ?></a>
			    	</div><!-- .site-info -->
			    </div><!-- .colophon-column -->
		    <?php endif; ?>
