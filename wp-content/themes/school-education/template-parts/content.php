...
<div class="blog-content">
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		$school_education_show_post_image = school_education_get_option( 'school_education_show_post_featured_image_setting' );
		if ( true === $school_education_show_post_image ) { ?>
			<div class="blog-img">
