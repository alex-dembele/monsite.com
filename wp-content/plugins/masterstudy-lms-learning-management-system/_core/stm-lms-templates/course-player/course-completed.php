...
if ( ! empty( $user_course['progress_percent'] ) ) {
	$course_passed = $user_course['progress_percent'] >= ( $settings['certificate_threshold'] ?? 70 );
}
	...
	<div class="masterstudy-course-player-course-completed__info">
		...
		<div class="masterstudy-course-player-course-completed__info-success">
			...
			<div class="masterstudy-course-player-course-completed__buttons">
				<?php
				if ( is_ms_lms_addon_enabled( 'certificate_builder' ) && $lesson_completed && $course_passed && masterstudy_lms_course_has_certificate( $post_id ) ) :
