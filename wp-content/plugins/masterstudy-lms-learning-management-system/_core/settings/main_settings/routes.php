...
function stm_lms_settings_route_section() {
	...
	if ( isset( $settings['courses_page_elementor'] ) && $settings['courses_page_elementor'] !== $archive_courses_page['elementor'] && $settings['courses_page_gutenberg'] !== $archive_courses_page['gutenberg'] ) {
		$settings['courses_page_elementor'] = ! empty( $archive_courses_page['elementor']['title'] ) ? $archive_courses_page['elementor']['title'] : esc_html__( 'Page not generated', 'masterstudy-lms-learning-management-system' );
		$settings['courses_page_gutenberg'] = ! empty( $archive_courses_page['gutenberg']['title'] ) ? $archive_courses_page['gutenberg']['title'] : esc_html__( 'Page not generated', 'masterstudy-lms-learning-management-system' );
