...
<div <?php echo wp_kses_data( $block_wrapper_attributes ); ?>>
	...
	<div class="lms-course-classic__list"></div>
</div>
...
<input type="hidden" class="lms-course-list-item-blocks" data-show-category="<?php echo esc_attr( $show_category ); ?>" data-show-price="<?php echo esc_attr( $show_price ); ?>" data-show-rating="<?php echo esc_attr( $show_rating ); ?>" data-show-divider="<?php echo esc_attr( $show_divider ); ?>" data-show-popup-instructor="<?php echo esc_attr( $show_popup_instructor ); ?>" data-show-popup-price="<?php echo esc_attr( $show_popup_price ); ?>" data-show-popup-wishlist="<?php echo esc_attr( $show_popup_wishlist ); ?>">
